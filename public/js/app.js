const myApp = angular.module('root', ['ngAnimate', 'toastr']);
myApp.controller('invertedController', ($scope, toastr) => {
  ...
  $scope.searchIndex = () => {
    ...
    if ($scope.indexedData === undefined && $scope.searchFileName !== 'all') {
  ...
  $scope.filteredData = (keyword) => {
    // if ($scope.searchFileName === 'all') {
    //   console.log($scope.searchAll);
    //   return invertedIndex.searchIndex(keyword, $scope.searchAll);
    // }
